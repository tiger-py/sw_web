import type { TechnologyFeatureCard } from "@/types/content";

type TechnologyFeatureCardsProps = {
  items: TechnologyFeatureCard[];
};

export function TechnologyFeatureCards({ items }: TechnologyFeatureCardsProps) {
  if (!items.length) {
    return null;
  }
